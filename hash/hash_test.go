...
func TestGroupAnagramsBaseSort(t *testing.T) {
	tests := []struct {
		name string
		strs []string
		want [][]string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := GroupAnagramsBaseSort(tt.strs)
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("GroupAnagramsBaseSort() = %v, want %v", got, tt.want)
			}
		})
	}
}

func TestGroupAnagramsBaseCount(t *testing.T) {
	tests := []struct {
		name string
		strs []string
		want [][]string
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			got := GroupAnagramsBaseCount(tt.strs)
			...
			if !reflect.DeepEqual(got, tt.want) {
				t.Errorf("GroupAnagramsBaseCount() = %v, want %v", got, tt.want)
			}
		})
	}
}
